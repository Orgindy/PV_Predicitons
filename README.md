...
Several scripts now accept file paths via command line arguments. Older versions
of this project used filenames with spaces. These scripts have been renamed with
underscores so they can be executed without quoting:
