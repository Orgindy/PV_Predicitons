...
with st.sidebar:
    ...
    # Set default emissivity and absorptivity values
    epsilon = 0.92  # pylint: disable=invalid-name
    alpha = 0.85  # pylint: disable=invalid-name
...
def validate_material_properties(emissivity, absorptivity):
